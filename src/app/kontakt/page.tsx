  ...
  return (
    <>
      <main className="w-screen">
        <section className="w-full h-fit bg-contact-page bg-cover min-h-screen relative text-white flex flex-col justify-center gap-12 p-2 pt-36 lg:gap-24 lg:p-12 lg:pt-48">
